...
namespace SmartLearning.Web.Controllers
{
  ...
  public class AccountController : Controller
  {
    ...
    public async Task<IActionResult> Initialize()
    {
      ...
      await _context.Boards.AddAsync(new Board { Name = "ICSE" });
      await _context.Boards.AddAsync(new Board { Name = "CBSE" });
      ...
      var board = await _context.Boards.Where(b => b.Name == "ICSE").FirstAsync();
